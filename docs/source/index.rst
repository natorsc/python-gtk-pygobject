...
.. meta::
   ...
   :description: Aprenda a criar interfaces gráficas com o toolkit GTK e a linguagem de programação Python.
   :description lang=en: Learn how to create graphical user interfaces with the GTK toolkit and the Python programming language.
