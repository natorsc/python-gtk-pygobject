...
class AdwPreferencesWindow(Adw.PreferencesWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK 4: PyGObject libadwaita Adw.PreferencesWindow()')
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK 4: PyGObject libadwaita Adw.AdwPreferencesPage()')
        self.set_default_size(width=int(1366 / 2), height=int(768 / 2))
        self.set_size_request(width=int(1366 / 2), height=int(768 / 2))
