# -*- coding: utf-8 -*-
"""Python e GTK 4: PyGObject Adw.CarouselIndicatorDots()."""
...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK 4: PyGObject Adw.CarouselIndicatorDots()')
        ...
        adw_carousel_indicator_dots.set_carousel(carousel=self.adw_carousel)
