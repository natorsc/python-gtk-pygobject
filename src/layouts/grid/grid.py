# -*- coding: utf-8 -*-
"""Container do tipo Grid layout.

Neste gerenciador de layout temos o posicionamento dos widgets em uma
estrutura que se assemelha a uma planilha eletrônica (linhas e colunas).
"""
...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self):
        ...
        self.set_title(title='Grid Layout')
