...
class ExampleWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.list_box.add_css_class(css_class='boxed-list-separate')
    ...
    def on_button_clicked(self, button):
        if 'boxed-list-separate' in self.list_box.get_css_classes():
            self.list_box.remove_css_class(css_class='boxed-list-separate')
        else:
            self.list_box.add_css_class(css_class='boxed-list-separate')
