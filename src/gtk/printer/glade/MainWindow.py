...
class Handler:
    ...
    def __init__(self):
        ...
        self.text_view_buffer = builder.get_object(name='text_view_buffer')
    ...
    def open_print_dialog(self, widget):
        ...
        response = print_operation.run(action=Gtk.PrintOperationAction.PRINT_DIALOG, parent=win)
    ...
    def open_preview(self, widget):
        ...
        print_operation = self._print_operation()
        response = print_operation.run(action=Gtk.PrintOperationAction.PREVIEW, parent=win)
    ...
    def export_to_pdf(self, widget):
        ...
        response = print_operation.run(action=Gtk.PrintOperationAction.EXPORT, parent=win)
