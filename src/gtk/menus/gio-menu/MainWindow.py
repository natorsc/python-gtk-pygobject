...
class Application(Gtk.Application):
    ...
    def do_startup(self):
        ...
        action_item1.connect('activate', self.menu_action_item1)
        self.add_action(action_item1)

        action_item2 = Gio.SimpleAction.new(name='item2', parameter_type=None)
        action_item2.connect('activate', self.menu_action_item2)
    ...
    def menu_action_item1(self, widget, parameter):
        print('menu_action_item1')

    def menu_action_item2(self, widget, parameter):
        print('menu_action_item2')
