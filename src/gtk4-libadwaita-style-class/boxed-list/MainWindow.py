# -*- coding: utf-8 -*-
"""Python e GTK 4: PyGObject libadwaita style class boxed-list."""
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK 4: PyGObject style classe boxed-list')
        ...
        adw_action_row_03.set_title(title='Item 03')
        listbox.append(child=adw_action_row_03)
