...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python and GTK: PyGObject style class circular')
        ...
        self.label = Gtk.Label.new(str="Classes: ['text-button', 'circular']")
        vbox.append(child=self.label)

        self.button_circular = Gtk.Button.new_from_icon_name(icon_name='audio-volume-high-symbolic')
        self.button_circular.set_vexpand(expand=True)
        self.button_circular.set_valign(align=Gtk.Align.CENTER)
        self.button_circular.set_halign(align=Gtk.Align.CENTER)
