# -*- coding: utf-8 -*-
"""Script para coletar informações dos widgets da biblioteca libadwaita."""
...
def open_template(template='templates/gtk-libadwaita.txt'):
...
def save_data(widget):
    ...
    path = Path().joinpath('info', f'libadwaita-{libadwaita_version}')
